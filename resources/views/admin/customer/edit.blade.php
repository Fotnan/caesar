...
@section('content')
    ...
    <!-- Main content --> {{dd($customer->districts->title)}}
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Клиент: "{{ $customer->name }}"</h3>
                        </div>
                        <!-- /.card-header -->


                        <form role="form" method="post" action="{{ route('customer.update', ['customer' => $customer->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group mx-1">
                                        ...
                                        <select name="category_id" class="form-control @error('category_id') is-invalid @enderror">
                                            <option value="{{$customer->category_id}}">{{$customer->title}}</option>
                                    ...
                                    <div class="form-group col-2 mx-1">
                                        ...
                                        <select name="district_id" class="form-control @error('district_id') is-invalid @enderror">
                                            <option value="{{$customer->district_id}}">{{$customer->$district->title}}</option>
                                    ...
                                    <div class="form-group col-2">
                                        ...
                                        <select name="city_id" class="form-control @error('city_id') is-invalid @enderror">
                                            <option value="{{$customer->city_id}}">{{$customer->name}}</option>
