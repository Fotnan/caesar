            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Восстановить клиента</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Клиент: "{{ $oldcustomer->name }}"</h3>
                        </div>
                        <!-- /.card-header -->

                        <form role="form" method="post" action="{{ route('oldcustomer.update', ['oldcustomer' => $oldcustomer->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group mx-1">
                                        ...
                                        <select name="category_id" class="form-control @error('category_id') is-invalid @enderror">
                                            <option value="{{$oldcustomer->category_id}}">{{$oldcustomer->title}}</option>
                                    ...
                                    <div class="form-group col-2">
                                        ...
                                        <select name="city_id" class="form-control @error('city_id') is-invalid @enderror">
                                            <option value="{{$oldcustomer->city_id}}">{{$oldcustomer->title}}</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <input type="text" name="utility"
                                               ...
                                               value="{{ $oldcustomer('utility') }}" >
                                    </div>
                                    <div class="form-group col-2">
                                        <label for="code">Код</label>
                                        <input type="text" name="code"
                                               class="form-control @error('code') is-invalid @enderror" id="code"
                                               value="{{ $oldcustomer('code') }}" >
                                    </div>
                                    <div class="form-check mt-4">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-8">
                                            ...
                                            <textarea class="form-control" name="notes" cols="47" rows="3" >{!! $oldcustomer('notes') !!}</textarea>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="form-control-file" id="scheme2">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
